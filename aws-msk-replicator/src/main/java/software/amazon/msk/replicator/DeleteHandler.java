...
public class DeleteHandler extends BaseHandlerStd {
    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        return ProgressEvent.progress(model, callbackContext)
            .then(progress ->
                proxy.initiate("AWS-MSK-Replicator::Delete", proxyClient, model, callbackContext)
                    .translateToServiceRequest(Translator::translateToDeleteRequest)
                    .backoffDelay(STABILIZATION_DELAY_DELETE)
                    .makeServiceCall(this::deleteResource)
                    .stabilize(this::stabilizedOnDelete)
                    .handleError((deleteReplicatorRequest, exception, _proxyClient, _resourceModel, _callbackContext) ->
    ...
    private DeleteReplicatorResponse deleteResource(
        ...
        try {
            return kafkaClient.injectCredentialsAndInvokeV2(deleteReplicatorRequest, kafkaClient.client()::deleteReplicator);
            ...
            if (MSK_API_PARAM_NAME_REPLICATOR_ARN.equals(e.invalidParameter()) && e.getMessage() != null
                ...
                logger.log(String.format("MSK API request for replicator deletion failed due to invalid replicatorArn %s " +
